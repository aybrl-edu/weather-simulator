...
const {getDataSource, putDataSource, getScenarioById, putParamsScenarioId, insertScenario, dropScenario}  = require('../../models/old-version/database.js');
...
exports.getSimulatorScenario = (req, res) => {
